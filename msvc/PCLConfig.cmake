...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "C:/Development/3rd_Party/boost_1_67_0")
  endif()
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "C:/Development/op3d_active/eigen-3.3.7" ABSOLUTE)
  endif()
  find_package(Eigen)
...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    set(OPENNI2_INCLUDE_DIRS_HINT "C:/Development/op3d_active/OpenNI2-2.2.0.33/Source/Core")
    get_filename_component(OPENNI2_LIBRARY_HINT "C:/Development/op3d_active/OpenNI2-2.2.0.33/msvc/vc141/x64/vs2017_Release/OpenNI2.lib" PATH)
  endif()
...
macro(find_ensenso)
  ...
  if(NOT ENSENSO_ROOT AND ("TRUE" STREQUAL "TRUE"))
    get_filename_component(ENSENSO_ABI_HINT "C:/Program Files/Ensenso/development/c/include" PATH)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    set(FLANN_ROOT "C:/Development/op3d_active/flann-1.6.11/src")
  endif()
...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-9.0" CACHE PATH "The directory containing VTKConfig.cmake")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-9.0" CACHE PATH "The directory containing VTKConfig.cmake")
    endif()
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "C:/Development/op3d_active/VTK-9.0.1/msvc" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
macro(find_external_library _component _lib _is_optional)
  message("Find_external_Library " ${_lib} " " ${_is_optional})
  ...
  if(${LIB}_FOUND)
	message("Variable " "${LIB}_FOUND" " is Set")
  else()
 	message("Variable " "${LIB}_FOUND" " is NOT Set")
  endif()
  if(${LIB}_FOUND)
...
#if( NOT $ENV{PCL_DIR} STREQUAL "" )
#   set(PCL_DIR "C:/Development/op3d_active/pcl-1.11.0")
#endif()
message("PCL_DIR " ${PCL_DIR})
set(PCL_LIBRARY_DIRS "${PCL_DIR}/x64/vs2017_Release")
set(PCL_DEBUG_LIBRARY_DIRS "${PCL_DIR}/x64/vs2017_Debug")
message("PCL_LIBRARY_DIRS " ${PCL_LIBRARY_DIRS})
message("PCL_DEBUG_LIBRARY_DIRS " ${PCL_DEBUG_LIBRARY_DIRS})
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "C:/Development/op3d_active/pcl-1.11.0")
else()
...
set(pcl_io_opt_dep openni2 ensenso pcap png vtk )
set(pcl_surface_opt_dep qhull )


# VTK components required by PCL
set(PCL_VTK_COMPONENTS "ChartsCore;CommonCore;CommonDataModel;CommonExecutionModel;FiltersCore;FiltersExtraction;FiltersModeling;ImagingCore;ImagingSources;InteractionStyle;InteractionWidgets;IOCore;IOGeometry;IOImage;IOLegacy;IOPLY;RenderingAnnotation;RenderingLOD;ViewsContext2D")
...
foreach(component ${PCL_TO_FIND_COMPONENTS})
  ...
  find_path(PCL_${COMPONENT}_INCLUDE_DIR
    ...
    NO_DEFAULT_PATH)
	message("PCL_${COMPONENT} Include Dir" ${PCL_${COMPONENT}_INCLUDE_DIR})
    mark_as_advanced(PCL_${COMPONENT}_INCLUDE_DIR)

  if(PCL_${COMPONENT}_INCLUDE_DIR)
    pcl_message("Include directory found for pcl_${component}.")
  ...
  if(_is_header_only EQUAL -1)
    message("Looking For " ${pcl_component} ${PCL_RELEASE_SUFFIX})
	set(PCL_${COMPONENT}_LIBRARY "${PCL_LIBRARY_DIRS}/${pcl_component}.lib")
	message(${pcl_component} ${PCL_${COMPONENT}_LIBRARY})
...
#      PATH)
	message("PCL_${COMPONENT}_LIBRARY " ${PCL_${COMPONENT}_LIBRARY})
    mark_as_advanced(PCL_${COMPONENT}_LIBRARY)

	set(PCL_${COMPONENT}_LIBRARY_DEBUG "${PCL_DEBUG_LIBRARY_DIRS}/${pcl_component}d.lib")
	message(${pcl_component} ${PCL_${COMPONENT}_LIBRARY_DEBUG})
#    find_library(PCL_${COMPONENT}_LIBRARY_DEBUG ${pcl_component}${PCL_DEBUG_SUFFIX}
#      HINTS ${PCL_DEBUG_LIBRARY_DIRS}
#      DOC "path to ${pcl_component} library debug"
#      NO_DEFAULT_PATH)
	message("PCL_${COMPONENT}_LIBRARY_DEBUG " ${PCL_${COMPONENT}_LIBRARY_DEBUG})
