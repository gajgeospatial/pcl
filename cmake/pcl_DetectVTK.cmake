# VTK 6.x components
#set (VTK_DIR "C:/Development/op3d_active/VTK-8.2.0/msvc")
message("VTK_DIR is set to " ${VTK_DIR})
set (QUITE OFF)
...
find_package(VTK COMPONENTS ${PCL_VTK_COMPONENTS} NO_MODULE)
message("Initial Find Package resutls " ${VTK_FOUND})
message("VTK_RENDERING_BACKEND " ${VTK_RENDERING_BACKEND})
message("RENDERING_BACKEND " ${RENDERING_BACKEND})
IF(VTK_FOUND)
  IF(VTK_RENDERING_BACKEND) #in vtk 7, the rendering backend is exported as a var.
      find_package(VTK COMPONENTS Rendering${VTK_RENDERING_BACKEND} ${PCL_VTK_COMPONENTS} NO_MODULE)
  ELSE(VTK_RENDERING_BACKEND)
      message("RENDERING Component not set ")
      find_package(VTK QUIET COMPONENTS RenderingOpenGL2 ${PCL_VTK_COMPONENTS} NO_MODULE)
      message("RENDERING_BACKEND " ${RENDERING_BACKEND})
